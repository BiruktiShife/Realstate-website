...
async function main() {
  ...
  const companies = [
    {
      ...
      description: "Luxury real estate specialists with over 20 years of experience in high-end residential and commercial properties.",
      ...
      propertiesCount: 2,
      rating: 4.8,
      specialties: JSON.stringify(["Luxury Homes", "Commercial", "Investment Properties"]),
      featured: true,
        ...
        create: [
          {
            ...
            features: JSON.stringify(["City View", "Private Terrace", "Concierge"]),
            status: "FOR_SALE",
            images: {
              create: [
                {
                  url: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&h=600&fit=crop",
                  description: "Stunning living room with floor-to-ceiling windows and city views",
                  order: 0,
                },
                {
          ...
          },
          {
            ...
            type: "COMMERCIAL",
            area: 2500,
            description: "Premium corner office space with floor-to-ceiling windows and city views",
            features: JSON.stringify(["Corner Unit", "City Views", "Modern Finishes", "Conference Room"]),
            status: "FOR_SALE",
            images: {
              create: [
                {
    ...
    },
    {
      ...
      description: "Modern urban properties for the contemporary lifestyle. Specializing in downtown apartments and condos.",
      ...
      propertiesCount: 2,
      rating: 4.6,
      specialties: JSON.stringify(["Urban Apartments", "Condos", "First-Time Buyers"]),
      featured: true,
              ...
              create: [
                {
                  ...
                  description: "Open-concept living space with industrial design elements",
                  order: 0,
                },
              ],
            },
  ...
  for (const companyData of companies) {
    ...
    console.log(`✅ Created company: ${company.name} with ${company.properties.length} properties`);
  }
